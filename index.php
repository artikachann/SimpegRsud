...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistem Informasi Kepegawaian RSUD Dr. M. Ashari Pemalang</title>
  ...
  <body class="login-page ">
    <div class="login-box gradient">
      <div class="login-logo">
        <h2><b>Sistem Informasi Kepegawaian<br/></b></h2><h3>RSUD Dr. M. Ashari Pemalang</h3>
      </div><!-- /.login-logo -->
      <div class="login-box-body ">
        <h4 class="login-box-msg">Silahkan login untuk masuk ke sistem!</h4>
        ...
        <form name="login-form" action="cek_login.php"  class="login-form" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
			  <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat"><i class="ace-icon fa fa-key"></i>Login</button>
            </div><!-- /.col -->
          </div>
        </form>         
