...
<h3 class="box-title margin text-center">Data Master Golongan</h3>
	<div class="box box-solid box-danger">
    <div class="box-header">
    <h3 class="btn disabled box-title">
    <i class="fa  fa-street-view"></i>
    Data Master Golongan</h3>  
    <a class="btn btn-default pull-right" href="?module=pangkat&aksi=tambah">
...
<form class="form-horizontal" action="<?php echo $aksi?>?module=pangkat&aksi=tambah" role="form" method="post">             
  ...
  <div class="form-group">
    <label class="col-sm-4 control-label">Nama Pangkat / Gol</label>
    <div class="col-sm-7">
...
<h3 class="box-title margin text-center">Edit Data Golongan "<?php echo $_GET['id_pangkat']; ?>"</h3>
<br/>
