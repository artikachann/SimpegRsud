...
<thead>
    ...
    <th class="col-sm-1">Nomor Pegawai</th>
...
<i class="fa fa-user-md"></i> Informasi Pegawai </h3>
  ...
  <div class="form-group">
    <label class="col-sm-4 control-label">Nomor Pegawai</label>
    <div class="col-sm-5">
...
<i class="fa fa-user-md"></i> Informasi Keluarga Pegawai </h3>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" required="required" name="id_kel" >
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label class="col-sm-4 control-label">Tempat & Tgl. Lahir</label>
    <div><div class="col-sm-2">
      <input type="text" class="form-control" required="required" name="tpt_lhr_kel" placeholder="Tempat Lahir">
  </div>
  <div class="col-sm-3">
    <div class="input-group">
  <div class="input-group-addon">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <textarea rowspan="2" class="form-control" name="hubungan"></textarea>
    </div>
  </div>  
  </div></div></div> 
...
<?php (@$h['pangkat']==$k['pangkat'])?print(" "):print(""); ?>	> <?php echo $k['id_pangkat']; echo " / ".$k['nm_pangkat']; ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
<select name="lokasi" class="form-control"><option value=" "> -- Pilih lokasi -- </option>
...
<div class="form-group">
    ...
    <div><div class="col-sm-2">
    <select name="jjg[]" class="form-control"><option value=""> Pilih Jenjang</option>
...
<i class="fa fa-user-md"></i> Edit Informasi Pegawai </h3>
  ...
  <div class="form-group">
    <label class="col-sm-4 control-label">Nomor Pegawai</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" readonly value="<?php echo $edit['no_pegawai']; ?>" name="nomor pegawai" >
    </div>
  </div>
	<div class="box-body">  
  <div class="form-group">
...
<div class="box-header">
<h3 class="btn btn disabled box-title">
<i class="fa fa-user-md"></i> Edit Informasi Keluarga Pegawai </h3>
  <a class="btn btn-default btn-sm pull-right" data-widget='collapse' data-toggle="tooltip" title="Collapse" style="margin-right: 5px;">
  <i class="fa fa-minus"></i></a>
    </div>  
  <div class="box-body">  
  <div class="form-group">
    <label class="col-sm-4 control-label">ID Keluarga</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" readonly value="<?php echo $edit['id_kel']; ?>" name="id_kel" >
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-4 control-label">Nama Keluarga Pegawai</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" value="<?php echo $edit['nm_kel']; ?>" name="nm_kel" placeholder="Nama keluarga pegawai">
    </div>
   <div class="form-group">
    <label class="col-sm-4 control-label">Tempat & Tgl. Lahir</label>
    <div><div class="col-sm-2">
      <input type="text" class="form-control" value="<?php echo $edit['tpt_lhr']; ?>" name="tpt_lhr_kel" placeholder="Tempat Lahir">
  </div>
  <div class="col-sm-3">
    <div class="input-group">
  <div class="input-group-addon">
      ...
      <input type="date" class="form-control" value="<?php echo $edit['tgl_lhr_kel']; ?>" data-toggle="tooltip" title="Format: yyyy/dd/mm" name="tgl_lhr">
  </div><!-- /.input group -->
  </div></div>
  </div>
  <div class="form-group">
    <label class="col-sm-4 control-label">Jenis Kelamin</label>
    <div class="col-sm-5">
    <input  class="minimal" name="jk" type="radio" value="Laki-laki" <?php if(($edit['jk_kel'])== "Laki-laki")
        {echo "checked=\"checked\"";};?>/> Laki-laki &nbsp;&nbsp;
    <input class="minimal" name="jk" type="radio" value="Perempuan" <?php if(($edit['jk_kel'])== "Perempuan")
        {echo "checked=\"checked\"";};?>/> Perempuan
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-5">  
    <select name="agama" class="form-control"><option> Pilih Agama</option>
  <option name="agama" value="Islam" <?php if(($edit['agama_kel'])== "Islam")
        {echo "selected=\"selected\"";};?>> Islam </option>
      <option name="agama" value="Kristen Protestan" <?php if(($edit['agama_kel'])== "Kristen Protestan")
        {echo "selected=\"selected\"";};?>> Kristen Protestan </option>
  <option name="agama" value="Kristen Katolik" <?php if(($edit['agama_kel'])== "Kristen Katolik")
        {echo "selected=\"selected\"";};?>> Kristen Katolik </option>
      <option name="agama" value="Hindu" <?php if(($edit['agama_kel'])== "Hindu")
        {echo "selected=\"selected\"";};?>> Hindu </option>
  <option name="agama" value="Budha" <?php if(($edit['agama_kel'])== "Budha")
        {echo "selected=\"selected\"";};?>> Budha </option>
  </select>
    </div>
  </div>
<div class="form-group">
    <label class="col-sm-4 control-label">Alamat</label>
    <div class="col-sm-5">
      <input rowspan="2" class="form-control" value="<?php echo $edit['alamat_kel']; ?>" name="alamat">
    </div>
  </div>  
  <div class="form-group">
    <label class="col-sm-4 control-label">Nomor HP</label>
    <div class="col-sm-5">
      <input type="number" class="form-control"  name="no_hp" value="<?php echo $edit['no_hp_kel']; ?>">
  </div>
  <div class="form-group">
    <label class="col-sm-4 control-label">Hubungan Keluarga Pegawai</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" value="<?php echo $edit['hubungan']; ?>" name="hubungan" placeholder="Hubungan keluarga pegawai">
    </div>
  </div></div></div>
...
<div id="main">
    <div class="my-form">
            <center>
			<p class="text-box">
                <a class="add-box btn btn-warning" href="#"> <i class="fa fa-plus"> </i> Add More</a>
            </p></center>
    </div>
</div>
<script type="text/javascript">
...
<ul class="nav nav-tabs">
	<li class="active"><a class="text-yellow" href="#data" data-toggle="tab">Info Pegawai</a></li>
	<li><a class="text-yellow" href="#data1" data-toggle="tab">Info Pekerjaan</a></li>
	<li><a class="text-yellow" href="#data2" data-toggle="tab">Info Pendidikan</a></li>
	<li><a class="text-yellow" href="#data3" data-toggle="tab">Pengalaman Kerja</a></li>
  <li><a class="text-yellow" href="#data4" data-toggle="tab">Info Keluarga Pegawai</a></li>
</ul>
