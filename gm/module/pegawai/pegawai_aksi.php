...
$status = $_POST['status'];$nip = $_POST['nip'];
$nm_kel = $_POST['nm_kel'];
$jk_kel = $_POST['jk_kel'];
...
$mySql3 = mysql_query("DELETE FROM prestasi WHERE no_pegawai='".$_GET['no_pegawai']."'");
$mySql4 = mysql_query("DELETE FROM hukuman WHERE no_pegawai='".$_GET['no_pegawai']."'");
$mySql5 = mysql_query("DELETE FROM sk_krj WHERE no_pegawai='".$_GET['no_pegawai']."'");
$mySql6 = mysql_query("DELETE FROM keluarga WHERE no_pegawai='".$_GET['no_pegawai']."'");
...
$thn_jjg = $_POST['add_thn_jjg'][$i];
    $query = "insert into pendidikan (no_pegawai, nip, thn_pend, jenjang, nm_pendidikan) 
	values('{no_pegawai}','{$nip}','{$thn_jjg}', '{$jjg}','{$nm_jjg}')";
...
$thn_krj = $_POST['add_thn_krj'][$j];
    $quer = "insert into pengalaman_krj (no_pegawai, nip, thn_krj, nm_krj, nm_pt) 
		values('{no_pegawai}', '{$nip}','{$thn_krj}', '{$nm_krj}','{$nm_pt}')";
...
//Tambah
	...
	header('location:../../index.php?module='.$module);
$sql = "INSERT INTO pegawai  (no_pegawai, nip, nm_pegawai, nm_wl_pegawai, jk, tpt_lhr, tgl_lhr, agama, alamat, alamat_wl, no_hp, no_hp_wl, email, tgl_msk) VALUES ('$no_pegawai', $nip', '$nm_pegawai', '$jk', '$tpt_lhr', '$tgl_lhr',  '$agama', '$alamat', '$alamat_wl', '$no_hp', '$email', '$tgl_msk')";
