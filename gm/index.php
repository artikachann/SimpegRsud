    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-lg"><b>Informasi Pegawai</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			...
			<th><h4 class="text-yellow">User</h4>
			</th>
			
			<tr>
			<td><i class="text-yellow">
				<a href="index.php?module=edit_user&id_user=<?php echo $_SESSION['id'];?>" class="btn btn-xs btn-warning ">&nbsp;<i class="fa fa-user"></i>&nbsp;</a> 
				&nbsp;&nbsp;
				<a href="../logout.php" class="btn btn-xs btn-warning ">&nbsp;<i class="fa fa-power-off"></i>&nbsp;</a>
			</td>
			</tr>
			</tr>
			</table>
      ...
      <div style="background:url(../images/0.png)repeat;" class="content-wrapper">
        ...
        <section  class="content-header">
          <h1> Sistem Informasi Kepegawaian
            <small>RSUD Dr. M. Ashari Pemalang</small>
          </h1>
          <ol class="breadcrumb">
	...
	<?php include "isi.php";?>        		
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Kepegawaian RSUD Dr. M. Ashari Pemalang
        </div>
        <strong>&copy; 2019 <a href="#">Nousdev</a>.</strong> 
		 </footer>
